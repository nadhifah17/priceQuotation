  ...
  <div class="card card-outline card-primary">
    <div class="card-header text-center">
        <a href="{{ fr_route('/') }}" class="mb-12">
          ...
          @endphp
          <img alt="Logo" src="{{ $model->getFirstMediaUrl('login_page_logo') ? $model->getFirstMediaUrl('login_page_logo') : ( $system_logo->getFirstMediaUrl('system_logo') ? $system_logo->getFirstMediaUrl('system_logo') : asset('assets/lte/rus.png') ) }}" style="max-width: 130px" />
        </a>
    </div>
    @if(env('DEMO_MODE') == 'On')
      <div class="mb-10">
    ...
    @endif
    <div class="card-body">
      <h3 class="widget-title">{{ __('view.sign_in') }}</h3>
      ...
      <form method="POST" action="{{ route('login.request') }}" novalidate="novalidate" id="kt_sign_in_form">
        ...
        <div class="form-group">
          ...
          <div class="input-group mb-3">
            <input type="email" class="form-control" name="email" id="email" placeholder="{{ __('view.Email') }}" autocomplete="off" value="{{ old('email', 'admin@admin.com') }}" required autofocus tabindex="1">
        ...
        <div class="form-group">
          ...
          <div class="input-group mb-5">
            <input type="password" class="form-control" name="password" id="password" placeholder="{{ __('view.Password') }}" autocomplete="off" required tabindex="2">
            <div class="input-group-append">
              <div class="input-group-text">
        ...
        <!-- <div class="row">
          ...
          <!-- /.col -->
          <div>
            <button type="submit" class="big-btn btn btn-primary btn-block" tabindex="3">{{-- __('view.login') --}} Login</button>
          </div>
          <!-- /.col -->
        <!-- </div> -->
      </form>
      ...
      <p class="register">
        <!--begin::Link-->
          <a href="{{ route('register') }}" tabindex="4">
              {{-- __('view.register_as_an_agent') --}} Register as an Agent
          </a>
        <!--end::Link-->
      </p>
      @endif
    ...
    <p class="tracking-now">
      <a href="#" tabindex="6">
        {{ __('view.tracking_now') }}
      </a>
    </p>
  </div>
  <!-- /.card -->
