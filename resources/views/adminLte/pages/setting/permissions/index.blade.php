    ...
    <script>
        ...
        function openModal(type, url = null) {
            ...
            if (type == 'create') {
                ...
                form.attr('url', "{{ route('setting.permissions.store') }}")
        ...
        function editItem(id) {
            let url = "{{ route('setting.permissions.edit', ':id') }}";
            ...
            $.ajax({
                ...
                error: function(err) {
                    setNotif(true, err.responseJSON ? err.responseJSON.message : 'Failed to show data');
                }
            })
        }
