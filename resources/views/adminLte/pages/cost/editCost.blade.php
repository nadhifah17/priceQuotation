                                                ...
                                                <table class="table table-cost">
                                                    ...
                                                    <tbody id="body-list-material">
                                                        @php
                                                            $material_total = 0;
                                                        @endphp
                                                        @foreach (DB::table('material_cost')->where('cost_id', $cost->id)->get() as $key => $item)
                                                            <tr>
                                                                <td>{{ $key + 1 }}</td>
                                                                <td>{{ $item->part_no }}</td>
                                                ...
                                                <table class="table table-cost">
                                                    ...
                                                    <tbody id="body-list-process">
                                                        ...
                                                        @php
                                                            $process_total = 0;
                                                        @endphp
                                                        @foreach (DB::table('process_cost')->where('cost_id', $cost->id)->get() as $key => $item)
                                                            <tr>
                                                                <td>{{ $key + 1 }}</td>
                                                                <td>{{ $item->part_no }}</td>
                                                                <td>{{ $item->part_name }}</td>
                                                ...
                                                <table class="table table-cost">
                                                    ...
                                                    <tbody id="body-list-purchase">
                                                        @php
                                                            $purchase_total = 0;
                                                        @endphp
                                                        @foreach (DB::table('purchase_cost')->where('cost_id', $cost->id)->get() as $key => $item)
                                                            <tr>
                                                                <td>{{ $key + 1 }}</td>
                                                                <td>{{ $item->part_no }}</td>
                                                                <td>{{ $item->part_name }}</td>
    ...
    <script>
        ...
        function submitHandler() {
            $.ajax({
                type: "POST",
                dataType: "json",
                url: "/api/submit-cost?update=true",
                data: {
