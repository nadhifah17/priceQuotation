...
@section('content')
            ...
            <div style="padding-top: 70px;">
                <div class="card">
                    <div class="card-body">
                                                ...
                                                <table class="table table-cost">
                                                    ...
                                                    <tbody id="body-list-material">
                                                        @php
                                                            $material_total = 0;
                                                        @endphp
                                                        @foreach (DB::table('material_cost_tmmin')->where('cost_id', $cost->id)->get() as $key => $item)
                                                            <tr>
                                                            <td>{{ $key + 1 }}</td>
                                                                <td>{{ $item->part_no }}</td>
                                                                ...
                                                                <td><button type="button"
                                                                        class="btn btn-danger button-delete-material"
                                                                        data-id="{{ $key }}">DEL</button></td>
                                                            </tr>
                                                            @php
                                                ...
                                                <table class="table table-cost">
                                                    ...
                                                    <tbody id="body-list-process">
                                                        ...
                                                        @php
                                                            $process_total = 0;
                                                        @endphp
                                                        @foreach (DB::table('process_cost_tmmin')->where('cost_id', $cost->id)->get() as $key => $item)
                                                            <tr>
                                                                <td>{{ $key + 1 }}</td>
                                                                <td>{{ $item->part_no }}</td>
                                                                <td>{{ $item->part_name }}</td>
                                                                ...
                                                                <td><button type="button" data-id="{{ $key }}"
                                                                        class="btn btn-danger button-delete-proccess">DEL</button>
                                                                </td>
                                                            </tr>
                                                            @php
                                                    ...
                                                    <tbody id="body-list-purchase">
                                                        ...
                                                        @foreach (DB::table('purchase_cost_tmmin')->where('cost_id', $cost->id)->get() as $key => $item)
                                                            <tr>
                                                                ...
                                                                <td>{{ $item->overhead }}</td>
                                                                <td>{{ $item->total }}</td>
                                                                <td><button class="btn btn-danger button-delete-purchase"
                                                                        type="button"
                                                                        data-id="{{ $key }}">DEL</button></td>
                                                            </tr>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" value="{{ $material_total }}"
                                            ...
                                            <div class="col-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" value="{{ $process_total }}"
                                                        class="form-control form-control-sm" readonly=""
                                            ...
                                            <div class="col-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" value="{{ $purchase_total }}"
                                                        class="form-control form-control-sm" readonly=""
                                            ...
                                            <div class="col-2">
                                                <div class="form-group">
                                                    <label for="summary_total_cost"
                                                        class="col-form-label label-grey">Total</label>
                                                    <input type="number"
                                                        value="{{ $material_total + $process_total + $purchase_total }}"
                                                        class="form-control form-control-sm cost-disabled" readonly=""
                        ...
                        <br>
                        <a href="{{ route('tmmin.download', ['id'=>$cost->id]) }}" class="btn btn-warning float-right" style="margin: 10px;">Download to excel</a>
                        <a href="{{ route('tmmin.result', ['id'=>$cost->id]) }}" class="btn btn-info float-right" style="margin: 10px;">View</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            var proc = @json($proc);
            proc.forEach((element, key) => {
                var val = {
                    "part_no": element.part_no,
                    "part_name": element.part_name,
                    "process_group": element.process_group,
                    "procces_code": element.process_code,
                    "process_rate": element.process_rate,
            ...
            var pur = @json($pur);
            pur.forEach((element, key) => {
                var val = {
                    "part_no": element.part_no,
                    "part_name": element.part_name,
                    "currency": element.currency,
                    "currency_type": element.type_currency,
                    "period": element.period,
                    "currency_value": element.value_currency,
                    "cost": element.cost,
    ...
    <script>
        ...
        $("#period").on('input', function() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $('#exchange_rate').val(parseFloat(data.currency_value.value) * parseFloat(data
                        .material_rate.rate))
                }
            });
        });
        $("#usage_part").on('input', function() {
            ...
            exchange_usage = parseFloat(exchange_rate) * parseFloat(usage_part)
            solve = pparseFloat(exchange_rate) * parseFloat(usage_part) + parseFloat(exchange_usage) * parseFloat(overhead)
            $('#subtotal').val(solve)
        });
        $("#overhead").on('input', function() {
            ...
            solve = parseFloat(exchange_rate) * parseFloat(usage_part) + parseFloat(exchange_usage) * parseFloat(overhead)
            $('#subtotal').val(solve)
        });
        ...
        $("#cycle_time").on('input', function() {
            ...
            exchange_rate = $('#exchange_rate').val();
            overhead = $('#overhead').val();
            cycle_head = parseFloat(process_rate) * parseFloat(cycle_time)
            solve = parseFloat(process_rate) * parseFloat(cycle_time) + parseFloat(cycle_head) * parseFloat(overhead)
            $('#subtotal').val(solve)
        });
        ...
        $("#purchase_cost_pc_cost").on('input', function() {
            ...
            cost_quantity_head = parseFloat(purchase_value_pc_cost) * parseFloat(purchase_cost_pc_cost) * parseFloat(
                purchase_quantity_pc_cost)
            solve = parseFloat(purchase_value_pc_cost) * parseFloat(purchase_cost_pc_cost) * parseFloat(
                purchase_quantity_pc_cost) + parseFloat(cost_quantity_head) * parseFloat(purchase_over_head_pc_cost)
        ...
        function addPurchaseToList() {
            ...
            console.log( $('#summary_total_cost').val());
        ...
        function submitHandler() {
            $.ajax({
                type: "POST",
                dataType: "json",
                url: "/api/submit-cost-tmmin?update=true",
                data: {
